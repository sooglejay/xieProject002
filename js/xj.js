...
$(function () {
    ...
    $('#btn_search').on('click', function () {
        ...
        $.ajax({
            type: 'post',
            url: 'http://wx.hankedata.com/index.php?part=search&appid=' + request('appid') + '&openid=' + request('openid'),
            dataType: 'json',
            data: {search: search},
            beforeSend: function () {
    ...
    $('#result').delegate('.btn-ckxq', 'click', function () {
        var id = $(this).data('id');
        window.location.href = 'http://wx.hankedata.com/index.php?part=xq&openid=' + request('openid') + '&appid=' + request('appid') + '&sid=' + id;
    });

    // 修改资料
    $('#result').delegate('.btn-xgzl', 'click', function () {
        var id = $(this).data('id');
        window.location.href = 'http://wx.hankedata.com/index.php?part=change&openid=' + request('openid') + '&appid=' + request('appid') + '&sid=' + id;
    });

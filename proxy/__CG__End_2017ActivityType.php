 ...
 */
class ActivityType extends \End_2017\ActivityType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'userType', 'orders', 'activityName', 'activityCode'];
        }
